...
from inkscape_layer_utils.layer import find_first_layer_by_name, get_layer_by_path
...
input_image_tree = ET.parse('../example/example_graphic_1.svg')

image = Image(input_image_tree)

print(image.get_all_layer_paths())

image.tear_apart_to_file('output/', 'example')

extracted_image = image.extract_layers(['/outline', '/eyes', '/eyes/left', '/eyes/right', '/mouth'])
print(extracted_image.get_all_layer_paths())
# layer = extracted_image.get_layer_by_path('outline')
# for object in layer.objects.values():
#     object.set_fill_color('#FF0000')
#
#
# for elem in extracted_image.element_tree.iter():
#     print(elem)

# layer.objects['path841-3'].set_fill_color('#FF0000')
# print()
# print(layer.objects['path841-3'].object_element)

extracted_image.save('foo.svg')
# image.print_structure()
